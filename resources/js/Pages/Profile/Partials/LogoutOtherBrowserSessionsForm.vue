		...
		<template #content>
			...
			>
				...
				>
					...
					<div class="ml-3">
						<div class="text-sm duration-200 dark:text-white text-gray-600">{{ session.agent.platform }} - {{ session.agent.browser }}</div>
