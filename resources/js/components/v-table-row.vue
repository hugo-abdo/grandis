<template>
	...
	>
		<tr key="details" v-if="showDeatails">
			<td colspan="12">
				<div
					class="shadow rounded-lg text-gray-500 bg-white shadow-lg dark:bg-groadis-dark dark:text-white w-[92vw] md:w-[93vw] lg:w-[90vw] overflow-auto max-h-[calc(100vh-12rem)]"
				>
					<slot
						name="details"
						:row="{ item }"
